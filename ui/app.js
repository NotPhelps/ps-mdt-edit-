...
$(document).ready(() => {
  ...
  $(".contextmenu").on("click", ".profile-jail", function () { 
   ...
   $(".contextmenu").on("click", ".profile-fine", function () { 

      
    $(".fine-container").fadeIn(0)
    $(".fine-inner-container").slideDown(500)
    $(".fine-inner-container").fadeIn(500)
    $(".fine-container").data("id", $(this).data("info"))
});
  ...
  $(".fine-buttons").on("click", ".fine-cancel", function () {
    $(".fine-inner-container").slideUp(500)
    $(".fine-inner-container").fadeOut(500)
    setTimeout(() => {
        $(".fine-container").slideUp(500)
        $(".fine-container").fadeOut(500)
        $(".fine-input").val("")
    }, 500)
})
...
$(".fine-buttons").on("click", ".fine-submit", function () {
    const fine = $(".fine-input").val()
    if (fine.length > 0) {
        let cid = $(".fine-container").data("id")
        $.post(`https://${GetParentResourceName()}/fineplayer`, JSON.stringify({
            cid: cid,
            fine: fine
        }));
        $(".fine-inner-container").slideUp(500)
